...
antisymmetry6y = locate_dofs_topological((Uy,Qy), 2, facet_tags.find(4))
antisymmetry5z = locate_dofs_topological((Uy,Qy), 2, facet_tags.find(5))
antisymmetry6z = locate_dofs_topological((Uy,Qy), 2, facet_tags.find(4))
...
n6 = dolfinx_mpc.utils.create_normal_approximation(U, facet_tags, symmetry_marker6)
...
with common.Timer("~Stokes: Create slip constraint"):
    ...
    mpc_u.create_slip_constraint(U, (facet_tags, symmetry_marker6), n6, bcs=bcs)
