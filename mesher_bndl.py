...
gmsh.merge(os.path.join(path, "Fibrous-cell-half.step"))

gmsh.option.setNumber("Mesh.MeshSizeMax", 0.000001)

gmsh.model.addPhysicalGroup(2, [1], 1, "Domain")
gmsh.model.addPhysicalGroup(1, [3], 2, "Inlet")
gmsh.model.addPhysicalGroup(1, [7], 3, "Outlet")
gmsh.model.addPhysicalGroup(1, [4,6], 4, "Wall_up")
gmsh.model.addPhysicalGroup(1, [8,2], 5, "Wall_down")
gmsh.model.addPhysicalGroup(1, [1], 6, "Wall_cyl1")
gmsh.model.addPhysicalGroup(1, [5], 7, "Wall_cyl2")
...
gmsh.write(os.path.join(path, "Fibrous-cell-half_meshbnd.msh"))
